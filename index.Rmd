...
author: "[Lety Kemp](https://twitter.com/letykemp) | Masters of Health Data Science"
date: " "
output:
  html_document:
    theme: cosmo
...
This page shows some of the methodology of an exploratory data analysis where I used R as a GIS to create risk rates for the region of Swansea, UK. 
...
The data sources were Open Data from UK authorities, but directly retrieved from [this](http://richfry.github.io/Exposure.html#introduction) tutorial by GIS specialist [Richard Fry](https://twitter.com/richfry). Richard was the lecturer of the GIS component of Data Visualisation, one of the modules of my [Master's Degree](http://www.swansea.ac.uk/medicine/learningandteaching/msc-health-data-science/).
...
This site was also created using RStudio with Rmarkdown, GitHub and Latex integrated. The [poster](Poster_A3_DataViz.pdf) was created in Adobe Illustrator.
