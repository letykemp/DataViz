...
author: "[Lety Kemp](https://twitter.com/letykemp) | MSc Health Data Science"
date: " "
output:
  html_document:
    theme: cosmo
...
Adjusted risk rates were calculated and illustrated in a quantile map. The end product was a [academic conference poster](Poster_A3_DataViz.pdf) presented in Data Visualisation, one of the modules of my [Master's Degree](http://www.swansea.ac.uk/medicine/learningandteaching/msc-health-data-science/).

The data sources were Open Data from UK authorities, but supplied by [Richard Fry](https://twitter.com/richfry), a GIS specialist who lecturered us and wrote [this](http://richfry.github.io/Exposure.html#introduction) great tutorial. 
...
This site was also created using RStudio together with Rmarkdown, GitHub and Latex. The [poster](Poster_A3_DataViz.pdf) was created in Adobe Illustrator. This site was **not** part of the assignment, however, I loved working with RStudio and just couldn't get enough of it! ♥♥♥ 
